...
$(TARGET): main.o isola.o random_agent.o our_agent.o
	$(CC) objects/main.o objects/isola.o objects/random_agent.o objects/our_agent.o -o $(TARGET)
...
our_agent.o: agents/ordered_agent.cpp agents/our_agent.h
	$(CC) $(CFLAGS) agents/our_agent.cpp -o objects/our_agent.o
